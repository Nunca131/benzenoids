...
\newcommand\Nancy[1]{\textcolor{violet}{Nancy: #1}}
\newcommand\Sarah[1]{\textcolor{cyan}{Sarah: #1}}
\newcommand\JF[1]{\textcolor{blue}{J\"{o}rg":#1}}
\newcommand\Thomas[1]{\textcolor{orange}{Thomas: #1}}
...
Topics in Science". \JF{Have to thank denbi here}
